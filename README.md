...
3. `report.py`: The presentation layer responsible for formatting, computing higher-level metrics, and printing the visual charts.
...
- Suspicious Activity Detection (Most Active IP): Identifies the top-requesting IP address
